<?php session_start(); $izena = $_SESSION['izena'] ?? null; ?>
<!DOCTYPE html>
<html lang="eu">
<head>
  <meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="Estiloa/estiloaOrokorra.css?v=1">
</head>
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <?php else: ?>
            ...
            <li class="nav-item"><a class="nav-link" href="gidaria/saioaHasi.php">Gidari Login</a></li>
          <?php endif; ?>
        </ul>
      </div>
    </div>
