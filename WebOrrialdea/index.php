<?php
    session_start();
    // Ziurtatu $izena eta $rola definituta daudela saiotik badatoz,
    // edo hasieratu itzazu erroreak ekiditeko erabiltzailea logeatuta ez badago.
    ...
    <head>
      ...
      <title>alaikToMUGI - Taxi Zerbitzuak</title>
          ...
          <style>
              ...
              {
                color: #007bff !important; /* Pasatzean kolorea */
              }
              ...
              .bg-primary 
              {
                background-color: #007bff !important; /* Bootstrap-en kolore nagusia */
              }
              ...
              .footer 
              {
                background-color: #343a40 !important; /* Orri-oin iluna */
              }
              ...
              /* "Zergatik Aukeratu Gu" atalaren estiloak */
              ...
              .why-choose-us .icon-box 
              {
                text-align: center;
                padding: 1.5rem;
                background-color: #f8f9fa; /* Atzeko plano orokorretik apur bat desberdina */
                border-radius: 0.5rem;
                box-shadow: 0 0.25rem 0.75rem rgba(0, 0, 0, 0.05);
                height: 100%; /* Kutxa guztiek altuera berdina izan dezaten ziurtatzen du */
                display: flex;
              ...
              {
                font-size: 4rem;
                color: #28a745; /* Kolore berde bat bereizteko edo kolore urdin nagusia */
                margin-bottom: 1rem;
              }
              ...
              /* "Gure Lorpenak" atalaren estiloak */
              .our-achievements 
              {
                background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url('Argazkia/city_night.jpg') no-repeat center center; /* Atzeko planoko irudi egoki bat kontuan hartu */
                background-size: cover;
                color: white;
              }
              .our-achievements .achievement-item 
              {
                text-align: center;
                padding: 1.5rem;
                margin-bottom: 2rem; /* Tartea gailu txikietarako */
              }
              .our-achievements .achievement-item h2 
              {
                ...
                font-weight: 700;
                margin-bottom: 0.5rem;
                color: #ffc107; /* Kontraste kolorea, Bootstrap-en horia */
              }
        ...
        <div class="container px-4 px-lg-5">
          <div class="row gx-4 gx-lg-5 align-items-center justify-content-center">
            <div class="col-lg-10">
              ...
              <?php if (!$izena): /* Erabiltzailea logeatuta ez badago, erakutsi botoia */ ?>
